...
<?php
    ...
    while($row = $res->fetch_object()){
        ...
        print "<td>
                    ...
                    <button onclick=\"if(confirm('Deseja realizar a exclusão do usuário?')){location.href='?page=salvar&acao=excluir&usuario_ID=".$row->usuario_ID."';}else{false;}\" class='btn btn-danger'>Excluir</button>
            </td>";
        print "</tr>";
    }
        print "</table>";
